...
MISSENSE_SCORE_RESOURCE_PATHS = {
    ...
    "MISFIT": "gs://missense-scoring/misfit_2025/MisFit_V1.5_SNV.txt.gz",
    "POPEVE": "gs://missense-scoring/popEVE_ukbb_20250312/*.csv",
    "MPC": "gs://gcp-public-data--gnomad/papers/2026-rmc/gnomad_v4.1.1_mpc.ht",
...
AF2_UNIPROT_ISOFORM_MAPPING_PATH = (
    "gs://genetics-gym/linkers/af2db_uniprot_mapping.ht"
)
...
FORMATTED_VSM_HT_PATHS = {
  ...
  #  "MISFIT_MAPPED": f"{WRITE_VSM_TABLES_PATH}/misfit_mapped.ht",
    "MPC": f"{WRITE_VSM_TABLES_PATH}/mpc.ht",
...
WRITE_VSM_LINKER_TABLES_BASE = "gs://genetics-gym/vsm-tables/linker_and_vsm/linker_"
