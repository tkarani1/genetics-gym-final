...
misfit_ht = hl.import_table("gs://missense-scoring/misfit_2025/MisFit_V1.5_SNV.txt.gz", 
...
misfit_ht = misfit_ht.rename({'TranscriptID': 'enst', 'MisFit_D':'MisFit_D_score', 'MisFit_S':'MisFit_S_score'})
misfit_ht = misfit_ht.key_by('locus', 'alleles', 'enst')
misfit_ht = misfit_ht.select('MisFit_D_score', 'MisFit_S_score')
